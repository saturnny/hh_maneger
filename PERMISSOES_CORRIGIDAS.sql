-- =================================================================
-- PERMISSÕES COMPLETAS PARA TODAS AS TABELAS (VERSÃO CORRIGIDA)
...
-- 4. VERIFICAÇÃO DAS PERMISSÕES CONCEDIDAS (CORRIGIDO)
SELECT 
    table_schema,
    table_name,
    grantee,
...
-- 5. VERIFICAÇÃO DO STATUS DO RLS
SELECT 
    schemaname,
    tablename,
    rowsecurity
...
-- 6. VERIFICAÇÃO DE USUÁRIOS EXISTENTES (para debug)
SELECT 
    id,
    nome,
    email,
